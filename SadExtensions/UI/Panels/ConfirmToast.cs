...
{
    public sealed class ConfirmToast
        : FramedPanel
    {
            ...
            : base(width: 36, height: 6, position: position)
        {
            ...
            var btnYes = new Button(10, 1)
            { 
                Text = "Yes", Position = new Point((_innerW / 2) - 12, row)
            };

            var btnNo = new Button(10, 1)
            { 
                Text = "No", Position = new Point((_innerW / 2) + 2, row)
            };
